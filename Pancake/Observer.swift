...
extension Cache {
    ...
    ///
    /// The observation is executed whenever the object, or any related object, is modified in the receiver. No guarantee is made on what
    ...
    ///   - observation: A closure that is executed whenever the object, or a related object, is modified in the cache
...
extension Cached {
    ...
    ///
    /// - Parameter observation: A closure that is executed whenever the object, or a related object, is modfied in the cache
